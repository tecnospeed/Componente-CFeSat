...
begin
//  FCFeSat.ConfigurarSoftwareHouse('00000000000000','aaaaaaaaa');  
  FCFeSat.LoadConfig;
...
begin
  edtSignAC.text := FCFeSat.GerarSignAC(FCFeSat.CnpjContribuinte, FCFeSat.CnpjSoftwareHouse);
end;
