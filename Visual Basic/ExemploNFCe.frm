...
Begin VB.Form frmPrincipal 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(0)=   "btnAtivarSat"
      Tab(0).Control(1)=   "btnConfInterRede"
      Tab(0).Control(2)=   "btnAssocAssinatura"
      ...
      Tab(1).Control(0)=   "btnTrocarCodAtiv"
      Tab(1).Control(1)=   "btnAtualizarSoftware"
      Tab(1).Control(2)=   "btnDesbloquearSat"
      Tab(1).Control(3)=   "btnBloquearSat"
      Tab(1).Control(4)=   "btnExtrairLogs"
